...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('affairs', django_mysql.models.ListCharField(models.CharField(choices=[('NOTIFICATION', 'Notification'), ('PROMOTION', 'Promotion'), ('GENERAL', 'General'), ('SETTINGS', 'Settings'), ('INVOICE', 'Invoice'), ('SUGGESTION', 'Suggestion')], max_length=15), max_length=79, size=5)),
